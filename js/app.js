(() => {
    ...
    function initSliders() {
        if (document.querySelector(".copper__slider")) new core(".copper__slider", {
            ...
            navigation: {
                prevEl: ".button-left-copper",
                nextEl: ".button-right-copper"
            },
            pagination: {
                el: ".swiper-pagination",
                clickable: true,
    ...
    da.init();
    const buttonLeft = document.querySelector(".button-left-copper");
    const buttonRight = document.querySelector(".button-right-copper");
    const mainSection = document.querySelector(".copper");
    document.querySelector(".swiper-slide__title");
    function clickButtonRight() {
        buttonRight.addEventListener("click", (function(e) {
            if (mainSection.classList.contains("image")) {
                mainSection.classList.remove("image");
                mainSection.classList.add("red");
            } else if (mainSection.classList.contains("red")) {
                mainSection.classList.remove("red");
                mainSection.classList.add("random");
            } else if (mainSection.classList.contains("random")) {
                mainSection.classList.remove("random");
                mainSection.classList.add("image");
            }
    ...
    clickButtonRight();
    clickButtonLeft();
    const firstPagBut = document.querySelector(".swiper-pagination-bullet");
    const secondPagBut = document.querySelector(".swiper-pagination-bullet");
    const thirdPagBut = document.querySelector(".swiper-pagination-bullet");
    firstPagBut.addEventListener("click", (function(e) {
        if (mainSection.classList.contains("image")) mainSection.classList.toggle("image");
    }));
    secondPagBut.addEventListener("click", (function(e) {
        mainSection.classList.toggle("red");
    }));
    thirdPagBut.addEventListener("click", (function(e) {
        mainSection.classList.toggle("random");
    }));
    ...
    var script_images = document.querySelectorAll(".product__icon");
    script_images.forEach((function(image) {
        image.addEventListener("mouseenter", (function() {
            this.parentNode.classList.add("swiper-slide--hover");
        }));
        image.addEventListener("mouseleave", (function() {
            this.parentNode.classList.remove("swiper-slide--hover");
        }));
    }));
    const counters = document.querySelectorAll("[data-cardCounter]");
